...
public class Voucher {
    ...
    public void setApplicableEvents(String applicableEvents) {
        this.applicableEvents = applicableEvents;
    }

    public String getApplicableTicketTypes() {
        return applicableTicketTypes;
    }

    public void setApplicableTicketTypes(String applicableTicketTypes) {
    ...
    public void setApplicableUserTypes(String applicableUserTypes) {
