!function (jQuery, undefined) {
    ...
    var _ISM = _R.is_mobile(), _ANDROID = _R.is_android(), checkIDS = function (a, b) {
        ...
        var b = new RegExp("../../../../webstrot.com/html/moviepro/html/themepunch.revolution.min.html", "gi"), c = "";
        return jQuery("script").each(function () {
            var a = jQuery(this).attr("src");
            a && a.match(b) && (c = a)
        }), c = c.replace("../../../../webstrot.com/html/moviepro/html/jquery.themepunch.revolution.min.html", ""), c = c.replace("../../../../webstrot.com/html/moviepro/html/jquery.themepunch.revolution.html", ""), c = c.split("?")[0]
        ...
        var c = a.split("https://www.webstrot.com/"), d = b.split("https://www.webstrot.com/");
        c.pop();
        for (var e = 0; e < d.length; e++) "." != d[e] && (".." == d[e] ? c.pop() : c.push(d[e]));
        return c.join("https://www.webstrot.com/")
